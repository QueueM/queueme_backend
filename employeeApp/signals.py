...
def update_employee_performance(sender, instance, created, **kwargs):
    """
    When an EmployeeDetailsModel instance is saved, update its AI performance data.
    """
    try:
        performance_data = calculate_employee_performance(instance)
        # Use a queryset update to avoid triggering recursion in signals
